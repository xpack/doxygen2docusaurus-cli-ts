...
export abstract class AbstractReimplementType extends AbstractParsedObjectBase {
  // Mandatory elements.
...
export class Reimplement extends AbstractReimplementType {
...
export class ReimplementedBy extends AbstractReimplementType {
  constructor (xml: DoxygenXmlParser, element: Object) {
    // console.log(elementName, util.inspect(element, { compact: false, depth: 999 }))
