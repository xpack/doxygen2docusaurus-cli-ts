...
} from './doxygen/data-model/doxyfile/doxyfiletype-dm.js'
import {
  DoxygenIndexDataModel,
  AbstractIndexDoxygenType,
} from './doxygen/data-model/index/indexdoxygentype-dm.js'
import {
...
import {
  ...
  IncludedByDataModel,
  AbstractIncType,
} from './doxygen/data-model/compounds/inctype-dm.js'
import {
  AbstractRefType,
  InnerClassDataModel,
  InnerDirDataModel,
  ...
  InnerPageDataModel,
} from './doxygen/data-model/compounds/reftype-dm.js'
import {
  AbstractLocationType,
  LocationDataModel,
} from './doxygen/data-model/compounds/locationtype-dm.js'
import {
...
} from './doxygen/data-model/compounds/templateparamlisttype-dm.js'
import {
  AbstractListOfAllMembersType,
  ListOfAllMembersDataModel,
} from './doxygen/data-model/compounds/listofallmemberstype-dm.js'
import {
...
} from './doxygen/data-model/index/indexcompoundtype-dm.js'
import {
  DoxygenFileOptionDataModel,
  AbstractDoxygenFileOptionType,
} from './doxygen/data-model/doxyfile/doxyfileoptiontype-dm.js'
import {
  IndexMemberDataModel,
  AbstractIndexMemberType,
} from './doxygen/data-model/index/indexmembertype-dm.js'
import {
  MemberRefDataModel,
  AbstractMemberRefType,
} from './doxygen/data-model/compounds/memberreftype-dm.js'
import {
  ParamDataModel,
  AbstractParamType,
} from './doxygen/data-model/compounds/paramtype-dm.js'
import {
  MemberDataModel,
  AbstractMemberType,
} from './doxygen/data-model/compounds/membertype-dm.js'
import {
  MemberDefDataModel,
  AbstractMemberDefType,
  AbstractMemberBaseType,
} from './doxygen/data-model/compounds/memberdeftype-dm.js'
import {
  TypeDataModel,
  DefValDataModel,
...
} from './doxygen/data-model/compounds/reimplementtype-dm.js'
import {
  EnumValueDataModel,
