...
{/* docusaurus-template-liquid/templates/common/docs/install/_common/_xpack/_prerequisites-cli-liquid.mdx */}
...
- A recent version of [Node.js](https://nodejs.org) (specified as "engines.node": ">=20.0")
