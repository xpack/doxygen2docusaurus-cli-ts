...
{/* docusaurus-template-liquid/templates/common/docs/install/_common/_xpack/_install-cli-liquid.mdx */}
...
`npm install @xpack/doxygen2docusaurus@2.2.2 --save-dev
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm install --location=global @xpack/doxygen2docusaurus@2.2.2
`} </CodeBlock>
