...
* identify the desired version
  of @xpack/doxygen2docusaurus, download it into a cache and unpack
...
* create a local symbolic link
  such as <code>xpacks/@xpack/doxygen2docusaurus</code> pointing to the
  versioned folder in the user's global xPacks store
* add <code>@xpack/doxygen2docusaurus</code> to
  `package.json` as a
  dependency; this associates a specific version of the doxygen2docusaurus with
