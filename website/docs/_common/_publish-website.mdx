...
- **Push** the `website` branch to GitHub
  ...
  the [website]https://xpack.github.io/doxygen2docusaurus/.
  :::
- Check out the `development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/xpack/doxygen2docusaurus-cli-ts/actions/workflows/publish-github-pages.yml) workflow
- **Refresh** the web page
- The new release blog post is available
at https://xpack.github.io/doxygen2docusaurus/blog/
