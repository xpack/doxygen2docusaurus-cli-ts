...
{/* docusaurus-template-liquid/templates/common/docs/maintainer/_common/_xpack/_content-liquid.mdx */}
...
```bash
npm install --location=global @xpack/doxygen2docusaurus@test
```
