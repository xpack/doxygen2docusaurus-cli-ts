...
# How to get help for doxygen2docusaurus
...
- Check the [GitHub Discussions](https://github.com/xpack/doxygen2docusaurus-cli-ts/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack/doxygen2docusaurus-cli-ts/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack/doxygen2docusaurus-cli-ts/discussions)
pages.
