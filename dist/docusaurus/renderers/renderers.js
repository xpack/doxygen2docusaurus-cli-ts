...
import { ConceptCodePartLinesRenderer, ConceptPartsLinesRenderer, } from './conceptparts.js';
export class Renderers {
    ...
    registerRenderers(workspace) {
        ...
        this.elementLinesRenderers.set('AbstractConceptCodePart', new ConceptCodePartLinesRenderer(workspace));
        this.elementLinesRenderers.set('AbstractConceptParts', new ConceptPartsLinesRenderer(workspace));
